...
public class BlockInfo {
    public static final Map<SoundType, String> soundName = new HashMap<>() {{
        ...
        put(SoundType.WEEPING_VINES, "weeping_vines");
    ...
    public static final Map<MaterialColor, String> mapColourName = new HashMap<>() {{
    ...
    public static final Map<Material, String> materialName = new HashMap<>() {{
